...
export const AdminLayoutRoutes: Routes = [
    ...
    { path: 'empaques/order', component: ListRawMaterialOrderComponent, data: { materialType: 2 }, canActivate: [canActivateV2]},
    { path: 'empaques/order/create', component: AddEditRawMaterialByProviderOrderComponent, data: { materialType: 2 }, canActivate: [canActivateV2]},
    { path: 'empaques/order/view/:id', component: ViewRawMaterialOrderComponent, data: { materialType: 2 }, canActivate: [canActivateV2]},
    { path: 'empaques/order/edit/:id', component: AddEditRawMaterialByProviderOrderComponent, data: { materialType: 2 }, canActivate: [canActivateV2]},
    ...
    { path: 'store/expenses/history/:id', component: ListStoreExpensesComponent, canActivate: [canActivateV2]},
    ...
    { path: 'consultas/pedidos', component: ListProductForSaleOrderComponent, data: { readOnly: true }, canActivate: [canActivateV2]},
    { path: 'consultas/pedidos/dashboard', component: DashboardFinishedProductOrderComponent, data: { readOnly: true }, canActivate: [canActivateV2]},
