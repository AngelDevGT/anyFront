...
@Component({ 
    templateUrl: 'summary-fp-inventory-factory.component.html',
    styleUrls: ['summary-fp-inventory-factory.component.scss']
})
export class SummaryFinishedProductInventoryFactoryComponent implements OnInit {
    inventory?: Inventory;
    ...
    setTableElements(elements?: InventoryElement[]){
        ...
        elements?.forEach((element: InventoryElement) => {
            const curr_row = [
                    ...
                    { type: "text", value: element.finishedProduct?.name, header_name: "Producto" },
