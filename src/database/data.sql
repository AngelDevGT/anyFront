...
-- Unidades por cajilla en producto terminado (finished_product.units_per_box, default 240).
-- getFinishedProductV3 / retrieveFinishedProductV4 / updateFinishedProductV3 -> clones de V2 / V3 / V2 con unitsPerBox.
-- retrieveProductForSaleInventoryV4 / V5 -> clones de V2 / V3 (con costo) con finishedProduct.unitsPerBox,
-- para las vistas "Docenas y unidades" y "Cajillas, docenas y unidades" del inventario de tienda.
...
-- Unidades por cajilla en el inventario de bodega de producto terminado y abarrotes.
-- retrieveFinishedProductInventoryV4 -> clon de /retrieveFinishedProductInventoryV3 + unitsPerBox.
-- Ver src/database/migrations/2026-09-14-units-per-box-factory-inventory.sql
INSERT INTO public.sql_queries (descripcion,"path",consulta_sql,principal_table,"type") VALUES
